                ...
                <div className={styles.contactInfo}>
                    ...
                    <div className={styles.infoItem}>
                        ...
                        <input
                            ...
                            defaultValue={client.propertyCondition}
                    ...
                    <div className={styles.infoItem} style={{ gridColumn: '1 / -1' }}>
                        ...
                        <input
                            name="propertyLink"
                            defaultValue={client.propertyLink}
                            className={styles.editInput}
                            placeholder="https://..."
                        />
                    </div>
                    <div className={styles.infoItem}>
                        ...
                        <input
                            ...
                            type="number"
                            step="0.01"
                            defaultValue={client.askingPrice}
                            className={styles.editInput}
                            placeholder="150000"
                        />
                    </div>
                                ...
                                >
                                    ...
                                    {titleCompanies.flatMap((tc) => tc.escrowAgents).map((agent: any) => (
                                        <option key={agent.id} value={agent.id}>
                                            {agent.name} ({titleCompanies.find((item) => item.id === agent.titleCompanyId)?.name})
                                        </option>
                                    ))}
                                </select>
                            </div>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                        {client.titleCompany && (
                            <div>
                                ...
                                {client.titleCompany.phone && (
                                    <span style={{ display: 'block', fontSize: '0.8rem', color: '#64748b' }}>{client.titleCompany.phone}</span>
                                )}
                            </div>
                        )}
                        {client.escrowAgent && (
